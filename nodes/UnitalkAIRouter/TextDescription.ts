...
const completeOperations: INodeProperties[] = [
	{
		...
		type: 'options',
		description:
			'The model which will generate the completion. <a href="https://unitalk.ai">Learn more</a>.',
		displayOptions: {
			show: {
				operation: ['complete'],
				resource: ['text'],
...
const editOperations: INodeProperties[] = [
	{
		...
		type: 'options',
		description:
			'The model which will generate the edited version. <a href="https://unitalk.ai">Learn more</a>.',
		displayOptions: {
			show: {
				operation: ['edit'],
				resource: ['text'],
...
const moderateOperations: INodeProperties[] = [
	{
		...
		type: 'options',
		description:
			'The model which will classify the text. <a href="https://unitalk.ai">Learn more</a>.',
		displayOptions: {
			show: {
				resource: ['text'],
				operation: ['moderate'],
